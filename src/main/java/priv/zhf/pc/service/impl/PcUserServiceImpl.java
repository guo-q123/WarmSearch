...
import priv.zhf.pc.mapper.PcUserMapper;
import priv.zhf.pc.service.PcUserService;
...
//        page = new MyPage(pcUsersList.subList(beginIndex, endIndex), total);
    ...
    @Override
    public priv.zhf.utils.requestMessage.MyPage searchById(int pageNo, int limit, String idSorted, List<Map> users) {
        return null;
    }
}
