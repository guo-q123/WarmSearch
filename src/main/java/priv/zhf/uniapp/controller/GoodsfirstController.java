...
import priv.zhf.uniapp.mapper.GoodsfirstMapper;
import priv.zhf.uniapp.service.GoodsfirstService;
...
public class GoodsfirstController {
    ...
    @GetMapping("/id")
    public priv.zhf.utils.requestMessage.ResultResponse queryUreteralDataById(@RequestParam("id") Integer id, @RequestParam("page") int pageNo, @RequestParam("limit") int limit, @RequestParam("sort") String idSort){
        priv.zhf.utils.requestMessage.ResultResponse res = null;
        List<Map> info = goodsfirstMapper.selectById(id);
        log.info("info====>"+info);
        priv.zhf.utils.requestMessage.MyPage page = this.goodsfirstService.searchById(pageNo, limit, idSort,info);
        res = new priv.zhf.utils.requestMessage.ResultResponse(priv.zhf.utils.requestMessage.Constants.STATUS_OK, priv.zhf.utils.requestMessage.Constants.MESSAGE_OK,page);
        return res;
    }
